...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ImageView iv_pswSwitch;
    ...
    private void initView() {
        ...
        TextView tv_retPsw = findViewById(R.id.tv_retPsw);
        Button btn_Login = findViewById(R.id.btn_Login);
        TextView tv_register = findViewById(R.id.tv_Register);
        TextView tv_web = findViewById(R.id.tv_web);
        iv_pswSwitch = findViewById(R.id.iv_pswSwitch);
        //设置点击事件监听器
        btn_Login.setOnClickListener(this);
        tv_register.setOnClickListener(this);
        iv_pswSwitch.setOnClickListener(this);
        tv_retPsw.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_retPsw:
                Intent intent = new Intent(LoginActivity.this,Retrievepsw.class);
                startActivity(intent);
                break;
            case R.id.tv_Register:
                Intent intent1 = new Intent(LoginActivity.this, RegisteredActivity.class);
                startActivity(intent1);
                finish();
                break;
            case R.id.tv_web:
                Intent intent2 = new Intent(LoginActivity.this, Web.class);
...
//                                editor.clear();
                    ...
                    if (match) {
                        if(match2){
                            ToastEx.success(getApplicationContext(),"成功记住密码").show();
//                            Toast.makeText(this, "成功记住密码", Toast.LENGTH_SHORT).show();
                            cb_rmbPsw.setChecked(true);
                        }
                        
                        ToastEx.success(getApplicationContext(),"登录成功").show();
//                        Toast.makeText(this, "登录成功", Toast.LENGTH_SHORT).show();
                        ...
                        ToastEx.error(getApplicationContext(),"用户名或密码不正确，请重新输入").show();
//                        Toast.makeText(this, "用户名或密码不正确，请重新输入", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    ToastEx.warning(getApplicationContext(),"请输入你的用户名或密码").show();
//                    Toast.makeText(this, "请输入你的用户名或密码", Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.iv_pswSwitch:
                if(!isOpenEye){
                    iv_pswSwitch.setImageResource(R.drawable.ic_eye_o);
                    isOpenEye = true;
                    //密码可见
                    et_Psw.setTransformationMethod(HideReturnsTransformationMethod.getInstance());
                }else {
                    iv_pswSwitch.setImageResource(R.drawable.ic_eye_u);
                    isOpenEye = false;
