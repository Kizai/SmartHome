...
//        String message = "识别结束，结果是”" + results[0] + "”";
        String message = recogResult.getOrigalJson();//TextView显示不了要加上这行
        sendStatusMessage(SpeechConstant.CALLBACK_EVENT_ASR_PARTIAL,
                message + "；原始json：" + recogResult.getOrigalJson());
//        sendStatusMessage(SpeechConstant.CALLBACK_EVENT_ASR_PARTIAL,message+ recogResult.getOrigalJson());
        if (speechEndTime > 0) {
